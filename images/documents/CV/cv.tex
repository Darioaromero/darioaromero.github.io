...
\cventry{\small 2022--today}{\small \textbf{New York University -Abu Dhabi}}{Post-Doctoral Associate} {}{}{Abu Dhabi, UAE. Person in Charge: Ph.D. Kevin O'Rourke.}
\cventry{\small 2014--2016}{\small \textbf{Inter-American Development Bank}}{Research Fellow} {}{}{Washington, DC USA. Person in Charge: Ph.D. Matias Busso.}
\cventry{\small 2013--2014}{\small \textbf{J-PAL LAC}}{Research Analyst} {}{}{Santiago, Chile. Person in Charge: Ph.D. Francisco Gallego.}
\cventry{\small 2010--2013}{\small \textbf{Universidad del Rosario}}{Research Assistant} {}{}{Bogot\'a, Colombia. Person in Charge: Ph.D. Juan Fernando Vargas.}
...
\cventry{\small Summer 2021, Fall 2020}{\small Introduction to Econometrics (Undergraduate)}{Columbia University} {}{}{Instructor: Seyhan Erden}
\cventry{\small Spring 2021}{\small Game Theory (Undergraduate)}{Columbia University} {}{}{Instructor: Qingmin Liu}
\cventry{\small Spring 2021}{\small Perspectives on Economic Studies (Ph.D. 1st Year course)}{Columbia University} {}{}{Instructor: Joseph Stiglitz and Suresh Naidu}
\cventry{\small Fall 2019, Fall 2017}{\small Political Economy (Undergraduate)}{Columbia University} {}{}{Instructor: John Marshall}
\cventry{\small Fall 2018}{\small Political Economy (Undergraduate)}{Columbia University} {}{}{Instructor: Alessandra Casella}
\cventry{\small Spring 2018}{\small Principles of Economics}{Columbia University} {}{}{Instructor: Nicola Zaniboni}
...
\cvcomputer{Statistical}{Stata, SPSS, Eviews, R, Matlab, Phyton}{Advanced}{Programming and Statistical Analysist}
...
{\textbf{The (unintended?) effects of US military training during the Cold War in Latin-America} (With Diego Martin) \\ }
{Have the U.S. foreign military policies impacted conflict and democracy in Latin America? We studied the School of the Americas (SOA), an army training program launched by the U.S. to train Latin American armed forces during the Cold War. We exploited variations from the number of SOA graduates over time in 18 countries and found that SOA  reduced democratic measures and increased repression from legal armies. We also studied the effects of SOA graduates in Argentina and Colombia using military promotion rules for officials and the military areas. We found that zones commanded by SOA graduates exhibited higher rates of civilian victimization during the military dictatorship in Argentina and civilian conflict in Colombia. However, we discovered that SOA promoted democratic values after the Cold War in the long term. Our findings show that cohorts with greater exposure to SOA trainees saw an increment of positive effects on support for democracy. Our research highlights the unintended consequences of foreign policies on recipient countries.}
\vspace*{0.35cm}
